class DockerCompletion < Formula
  ...
  url "https://github.com/docker/cli/archive/refs/tags/v29.4.2.tar.gz"
  ...
  bottle do
    sha256 cellar: :any_skip_relocation, all: "bbec4d44b055814d14e744cddaade3bdc6fa8e5f27c8400d1eb566cd2664ef9c"
  end
