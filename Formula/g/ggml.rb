class Ggml < Formula
  ...
  url "https://github.com/ggml-org/ggml/archive/refs/tags/v0.9.10.tar.gz"
  ...
  resource "test-backend-ops.cpp" do
    url "https://raw.githubusercontent.com/ggml-org/ggml/refs/tags/v0.9.10/tests/test-backend-ops.cpp"
